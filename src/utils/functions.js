    ...
    async welcomeKoya(data) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                ctx.beginPath();
                ctx.arc(185, 240, 100, 0, Math.PI * 2, true); //position of img
                ctx.lineWidth = 15;
                ctx.strokeStyle = data.borderColor
                ctx.stroke();
                ctx.closePath();
                ...
                //draw the avatar
                ctx.drawImage(avatar, 85, 140, 200, 200);
                ctx.restore();
                //TEXTO BIENVENIDA
                ...
                ctx.fillText(`${data.username}`, 850, 270, 300, 350)
                //CONTADOR DE MIEMBRO
